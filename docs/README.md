...
**MP Sentinel fills that gap.** v1.0.6 introduces critical fixes for local commit review, interactive picker improvements, and synchronized CLI logic.
...
MP Sentinel v1.0.6 supports multiple AI providers in CI/CD pipelines. Choose the provider that fits your needs.
