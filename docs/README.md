...
**MP Sentinel fills that gap.** v1.0.5 introduces offline agent skills integration, interactive local review, and smarter techStack matching.
...
MP Sentinel v1.0.5 supports multiple AI providers in CI/CD pipelines. Choose the provider that fits your needs.
