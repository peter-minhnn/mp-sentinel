...
- [![NPM Version](https://img.shields.io/badge/npm-v1.19.0-blue?style=flat-square)](https://www.npmjs.com/package/mp-sentinel)
...
See [WHATS_NEW.md](./WHATS_NEW.md) for the latest features in **v1.19.0**:
