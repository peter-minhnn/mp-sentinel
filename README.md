...
- [![NPM Version](https://img.shields.io/badge/npm-v3.0.2-blue?style=flat-square)](https://www.npmjs.com/package/mp-sentinel)
...
See [WHATS_NEW.md](./WHATS_NEW.md) for the latest features in **v3.0.2**.
