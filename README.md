...
- [![NPM Version](https://img.shields.io/badge/npm-v3.2.4-blue?style=flat-square)](https://www.npmjs.com/package/mp-sentinel)
...
See [WHATS_NEW.md](./WHATS_NEW.md) for the latest features in **v3.2.4**.
